          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-gray-700 dark:text-gray-300">Counter:</span>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-yellow-700 dark:text-yellow-300">
                Press <kbd className="px-2 py-1 text-xs font-semibold bg-yellow-100 dark:bg-yellow-800 rounded">Ctrl+Shift+M</kbd> or click the floating button to open MSW DevTools.
              </p>
            </div>
          </div>
        </div>
